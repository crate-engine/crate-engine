...
export class TeamProcess {
    ...
    procs = new Map();
    blends = new Map();
    constructor(projectRoot, spawner, blendStarter, // mutable — see adoptBlendStarter
    ...
    busySeats() {
        const out = [];
        for (const [seat, b] of this.blends)
            if (b.alive() && b.responding())
                out.push(seat);
...
export function teamProcessFor(projectRoot, spawner, blendStarter, home) {
...
export function peekBusy(projectRoot) {
