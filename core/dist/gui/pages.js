...
`;
function shell(title, here, body, js) {
...
export function welcomePage(version, project) {
...
export function staffingPage() {
    ...
    return shell("Your team", "/staffing", `
<h1>Your team</h1>
...
export function attachPage() {
    return shell("Your project", "/attach", `
...
export function startPage() {
    return shell("Start the engine", "/start", `
