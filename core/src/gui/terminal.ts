...
export function terminalPlan(cmd: string, platform: NodeJS.Platform = process.platform): TerminalPlan {
  if (platform === "darwin") {
...
export function openSignInTerminal(
  cmd: string,
  platform: NodeJS.Platform = process.platform,
): { mode: "run" | "none"; note: string } {
